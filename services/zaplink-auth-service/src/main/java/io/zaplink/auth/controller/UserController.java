...
@Slf4j @RestController @RequiredArgsConstructor @RequestMapping("/users")
public class UserController
{
    ...
    public ResponseEntity<BaseResponse> updateUser( @PathVariable("userId") @P("userId") Long userId,
