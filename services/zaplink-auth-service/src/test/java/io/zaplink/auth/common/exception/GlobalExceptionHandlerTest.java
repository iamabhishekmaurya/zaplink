...
class GlobalExceptionHandlerTest
{
    ...
    void handleAuthException_ShouldReturnUnauthorizedResponse()
    {
        ...
        // When
        ProblemDetail response = globalExceptionHandler.handleAuthException( authException );
        // Then
        assertEquals( HttpStatus.UNAUTHORIZED.value(), response.getStatus() );
        assertEquals( message, response.getDetail() );
        assertEquals( errorCode, response.getProperties().get( "errorCode" ) );
    }
    ...
    void handleUserAlreadyExistsException_ShouldReturnConflictResponse()
    {
        ...
        // When
        ProblemDetail response = globalExceptionHandler.handleUserAlreadyExistsException( userAlreadyExistsException );
        // Then
    ...
    void handleUserNotFoundException_ShouldReturnNotFoundResponse()
    {
        ...
        // When
        ProblemDetail response = globalExceptionHandler.handleUserNotFoundException( userNotFoundException );
        // Then
    ...
    void handleAuthenticationException_ShouldReturnUnauthorizedResponse()
    {
        ...
        // When
        ProblemDetail response = globalExceptionHandler.handleAuthenticationException( authenticationException );
        // Then
        assertEquals( HttpStatus.UNAUTHORIZED.value(), response.getStatus() );
        assertEquals( ApiConstants.MESSAGE_AUTHENTICATION_FAILED, response.getDetail() );
        assertEquals( ApiConstants.ERROR_AUTHENTICATION_FAILED, response.getProperties().get( "errorCode" ) );
    }
    ...
    void handleBadCredentialsException_ShouldReturnUnauthorizedResponse()
    {
        ...
        // When
        ProblemDetail response = globalExceptionHandler.handleBadCredentialsException( badCredentialsException );
        // Then
        assertEquals( HttpStatus.UNAUTHORIZED.value(), response.getStatus() );
        assertEquals( ApiConstants.MESSAGE_INVALID_EMAIL_OR_PASSWORD, response.getDetail() );
        assertEquals( ApiConstants.ERROR_INVALID_CREDENTIALS, response.getProperties().get( "errorCode" ) );
    }
    ...
    void handleAccessDeniedException_ShouldReturnForbiddenResponse()
    {
        ...
        // When
        ProblemDetail response = globalExceptionHandler.handleAccessDeniedException( accessDeniedException );
        // Then
        assertEquals( HttpStatus.FORBIDDEN.value(), response.getStatus() );
        assertEquals( ApiConstants.MESSAGE_ACCESS_DENIED, response.getDetail() );
        assertEquals( ApiConstants.ERROR_ACCESS_DENIED, response.getProperties().get( "errorCode" ) );
    }
    ...
    void handleValidationExceptions_ShouldReturnBadRequestResponse()
    {
        ...
        // When
        ProblemDetail response = globalExceptionHandler.handleValidationExceptions( methodArgumentNotValidException );
        // Then
        assertEquals( HttpStatus.BAD_REQUEST.value(), response.getStatus() );
        assertEquals( ApiConstants.MESSAGE_VALIDATION_FAILED, response.getDetail() );
        assertEquals( ApiConstants.ERROR_VALIDATION_ERROR, response.getProperties().get( "errorCode" ) );
    }
    ...
    void handleGlobalException_ShouldReturnInternalServerErrorResponse()
    {
        ...
        // When
        ProblemDetail response = globalExceptionHandler.handleGlobalException( exception );
        // Then
        assertEquals( HttpStatus.INTERNAL_SERVER_ERROR.value(), response.getStatus() );
        assertEquals( ApiConstants.MESSAGE_UNEXPECTED_ERROR, response.getDetail() );
        assertEquals( ApiConstants.ERROR_INTERNAL_SERVER_ERROR, response.getProperties().get( "errorCode" ) );
    }
