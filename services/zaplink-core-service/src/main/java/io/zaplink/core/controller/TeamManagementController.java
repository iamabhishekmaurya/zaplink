...
public class TeamManagementController
{
   ...
   */
  @PostMapping(value = ControllerConstants.TEAM_INVITE_PATH, version = ControllerConstants.API_VERSION_1) @Operation(summary = ControllerConstants.TEAM_INVITE_MEMBER_SUMMARY, description = ControllerConstants.TEAM_INVITE_MEMBER_DESC) @ApiResponses(value =
   ...
   */
  @PutMapping(value = ControllerConstants.TEAM_MEMBER_ROLE_PATH, version = ControllerConstants.API_VERSION_1) @Operation(summary = ControllerConstants.TEAM_CHANGE_ROLE_SUMMARY, description = ControllerConstants.TEAM_CHANGE_ROLE_DESC) @ApiResponses(value =
   ...
   */
  @DeleteMapping(value = ControllerConstants.TEAM_MEMBER_REMOVE_PATH, version = ControllerConstants.API_VERSION_1) @Operation(summary = ControllerConstants.TEAM_REMOVE_MEMBER_SUMMARY, description = ControllerConstants.TEAM_REMOVE_MEMBER_DESC) @ApiResponses(value =
   ...
   */
  @GetMapping(value = ControllerConstants.TEAM_MEMBERS_PATH, version = ControllerConstants.API_VERSION_1) @Operation(summary = ControllerConstants.TEAM_GET_MEMBERS_SUMMARY, description = ControllerConstants.TEAM_GET_MEMBERS_DESC) @ApiResponses(value =
