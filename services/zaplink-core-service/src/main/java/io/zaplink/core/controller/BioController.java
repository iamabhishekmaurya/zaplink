...
public class BioController
{
    ...
    @PostMapping(value = ControllerConstants.BIO_PAGE_PATH) @Operation(summary = ControllerConstants.BIO_CREATE_PAGE_SUMMARY, description = ControllerConstants.BIO_CREATE_PAGE_DESC) @ApiResponses(value =
    ...
    @PutMapping(value = ControllerConstants.BIO_PAGE_PATH
            + "/{pageId}") @Operation(summary = ControllerConstants.BIO_UPDATE_PAGE_SUMMARY, description = ControllerConstants.BIO_UPDATE_PAGE_DESC) @ApiResponses(value =
    ...
    @DeleteMapping(value = ControllerConstants.BIO_PAGE_PATH
            + "/{pageId}") @Operation(summary = ControllerConstants.BIO_DELETE_PAGE_SUMMARY, description = ControllerConstants.BIO_DELETE_PAGE_DESC) @ApiResponses(value =
    ...
    @PostMapping(value = ControllerConstants.BIO_LINK_PATH) @Operation(summary = ControllerConstants.BIO_CREATE_LINK_SUMMARY, description = ControllerConstants.BIO_CREATE_LINK_DESC) @ApiResponses(value =
    ...
    @PutMapping(value = ControllerConstants.BIO_LINK_PATH
            + "/{linkId}") @Operation(summary = ControllerConstants.BIO_UPDATE_LINK_SUMMARY, description = ControllerConstants.BIO_UPDATE_LINK_DESC) @ApiResponses(value =
    ...
    @DeleteMapping(value = ControllerConstants.BIO_LINK_PATH
            + "/{linkId}") @Operation(summary = ControllerConstants.BIO_DELETE_LINK_SUMMARY, description = ControllerConstants.BIO_DELETE_LINK_DESC) @ApiResponses(value =
    ...
    @PutMapping(value = ControllerConstants.BIO_LINK_REORDER_PATH) @Operation(summary = ControllerConstants.BIO_REORDER_LINKS_SUMMARY, description = ControllerConstants.BIO_REORDER_LINKS_DESC) @ApiResponses(value =
