...
public final class ControllerConstants
{
    ...
    public static final String  SHORT_URL_STATUS_PATH                 = "/url/{shortUrlKey}/status";
    ...
    public static final String  CORE_TOGGLE_SHORT_URL_STATUS_SUMMARY  = "Toggle short URL status";
    public static final String  CORE_TOGGLE_SHORT_URL_STATUS_DESC     = "Activates or deactivates a short URL";
    public static final String  CORE_DELETE_SHORT_URL_SUMMARY         = "Delete short URL";
    public static final String  CORE_DELETE_SHORT_URL_DESC            = "Deletes a short URL permanently";
    ...
    public static final String  RESPONSE_200_SHORT_URL_STATUS_TOGGLED = "Short URL status toggled successfully";
    public static final String  RESPONSE_200_SHORT_URL_DELETED        = "Short URL deleted successfully";
