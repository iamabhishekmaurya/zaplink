...
public class QrController
{
  ...
  @PostMapping(value = ControllerConstants.QR_DYNAMIC_PATH, version = ControllerConstants.API_VERSION_1) @Operation(summary = ControllerConstants.QR_CREATE_DYNAMIC_SUMMARY, description = ControllerConstants.QR_CREATE_DYNAMIC_DESC) @ApiResponses(value =
  ...
  @PutMapping(value = ControllerConstants.QR_DYNAMIC_PATH
      + "/{qrKey}", version = ControllerConstants.API_VERSION_1) @Operation(summary = ControllerConstants.QR_UPDATE_DYNAMIC_SUMMARY, description = ControllerConstants.QR_UPDATE_DYNAMIC_DESC) @ApiResponses(value =
  ...
  @PutMapping(value = ControllerConstants.QR_DESTINATION_PATH, version = ControllerConstants.API_VERSION_1) @Operation(summary = ControllerConstants.QR_UPDATE_DESTINATION_SUMMARY, description = ControllerConstants.QR_UPDATE_DESTINATION_DESC) @ApiResponses(value =
  ...
  @PutMapping(value = ControllerConstants.QR_STATUS_PATH, version = ControllerConstants.API_VERSION_1) @Operation(summary = ControllerConstants.QR_TOGGLE_STATUS_SUMMARY, description = ControllerConstants.QR_TOGGLE_STATUS_DESC) @ApiResponses(value =
  ...
  @DeleteMapping(value = ControllerConstants.QR_DYNAMIC_PATH
      + "/{qrKey}", version = ControllerConstants.API_VERSION_1) @Operation(summary = ControllerConstants.QR_DELETE_DYNAMIC_SUMMARY, description = ControllerConstants.QR_DELETE_DYNAMIC_DESC) @ApiResponses(value =
  ...
  @PostMapping(value = ControllerConstants.QR_STYLED_PATH, version = ControllerConstants.API_VERSION_1, produces = MediaType.IMAGE_PNG_VALUE) @Operation(summary = ControllerConstants.QR_GENERATE_STYLED_SUMMARY, description = ControllerConstants.QR_GENERATE_STYLED_DESC) @ApiResponses(value =
  ...
  @GetMapping(value = ControllerConstants.QR_OPTIONS_PATH, version = ControllerConstants.API_VERSION_1) @Operation(summary = ControllerConstants.QR_GET_OPTIONS_SUMMARY, description = ControllerConstants.QR_GET_OPTIONS_DESC) @ApiResponses(value =
