...
import io.zaplink.processor.entity.UrlMappingEntity;
        ...
        JpaRepository<UrlMappingEntity, Long>
{
        ...
        /**
         * Increments the click count for a specific URL mapping by a custom amount.
         * Used for batch processing to update counts efficiently.
         * 
         * @param shortUrlKey the unique identifier for the URL to update
         ...
         * @throws IllegalArgumentException if shortUrlKey is null or empty
         */
        @Modifying @Query(QueryConstants.INCREMENT_CLICK_COUNT_BY)
        int incrementClickCountBy( @Param("shortUrlKey") String shortUrlKey, @Param("incrementBy") long incrementBy );
