...
public final class ExceptionConstants
{
    ...
    // Folder
    public static final String ERR_FOLDER_NOT_FOUND        = "Folder not found with id: ";
    public static final String ERR_FOLDER_NOT_EMPTY        = "Folder is not empty.";
    public static final String ERR_PARENT_FOLDER_NOT_FOUND = "Parent folder not found with id: ";
}
