package io.zaplink.media.common.trace;
 ...
 */
@Slf4j @Component @Order(Ordered.HIGHEST_PRECEDENCE)
    ...
    OncePerRequestFilter
{
    ...
    protected boolean shouldNotFilter( HttpServletRequest request )
    {
        ...
        return path.startsWith( AppConstants.PATH_ACTUATOR ) || path.startsWith( AppConstants.PATH_HEALTH );
    }
}
