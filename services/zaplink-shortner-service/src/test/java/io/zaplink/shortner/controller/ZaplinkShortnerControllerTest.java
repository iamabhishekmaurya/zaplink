...
@WebMvcTest(ZaplinkShortnerController.class)
class ZaplinkShortnerControllerTest
{
    @Autowired
        ...
        throws Exception
    {
        ...
        when( urlShortnerService.shortUrl( any( ShortnerRequest.class ) ) ).thenReturn( response );
