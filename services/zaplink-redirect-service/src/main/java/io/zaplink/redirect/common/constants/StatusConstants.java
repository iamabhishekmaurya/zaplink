...
public final class StatusConstants
{
    ...
    public static final String STATUS_301_MOVED_PERMANENTLY     = "301";
    public static final String STATUS_302_FOUND                 = "302";
    ...
    public static final String STATUS_410_GONE                  = "410";
