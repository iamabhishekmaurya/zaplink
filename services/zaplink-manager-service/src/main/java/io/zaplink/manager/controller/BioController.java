...
public class BioController
{
  ...
  @GetMapping("/pages/id/{id}") @Operation(summary = ControllerConstants.BIO_GET_PAGE_SUMMARY, description = ControllerConstants.BIO_GET_PAGE_DESC) @ApiResponses(value =
  { @ApiResponse(responseCode = StatusConstants.STATUS_200_OK, description = ControllerConstants.RESPONSE_200_BIO_PAGE_RETRIEVED, content = @Content(schema = @Schema(implementation = BioPageResponse.class))),
    @ApiResponse(responseCode = StatusConstants.STATUS_404_NOT_FOUND, description = ControllerConstants.RESPONSE_404_BIO_PAGE_NOT_FOUND) })
  public ResponseEntity<BioPageResponse> getBioPageById( @Parameter(description = ControllerConstants.PARAM_BIO_PAGE_ID) @PathVariable("id") Long id )
  {
    return ResponseEntity.ok( bioReadService.getBioPageById( id ) );
  }
  ...
  public ResponseEntity<List<BioPageResponse>> getBioPagesByOwner( @Parameter(description = ControllerConstants.PARAM_OWNER_ID) @PathVariable("ownerId") String ownerId )
  {
  ...
  public ResponseEntity<BioLinkResponse> getBioLinkById( @Parameter(description = ControllerConstants.PARAM_BIO_LINK_ID) @PathVariable("id") Long id )
  {
  ...
  { @ApiResponse(responseCode = StatusConstants.STATUS_200_OK, description = ControllerConstants.RESPONSE_200_BIO_LINKS_RETRIEVED, content = @Content(schema = @Schema(implementation = BioLinkResponse.class))),
    @ApiResponse(responseCode = StatusConstants.STATUS_404_NOT_FOUND, description = ControllerConstants.RESPONSE_404_BIO_PAGE_NOT_FOUND) })
  public ResponseEntity<List<BioLinkResponse>> getBioLinksByPageId( @Parameter(description = ControllerConstants.PARAM_BIO_PAGE_ID) @PathVariable("pageId") Long pageId )
  {
  ...
  { @ApiResponse(responseCode = StatusConstants.STATUS_200_OK, description = ControllerConstants.RESPONSE_200_BIO_LINKS_RETRIEVED, content = @Content(schema = @Schema(implementation = BioLinkResponse.class))),
    @ApiResponse(responseCode = StatusConstants.STATUS_404_NOT_FOUND, description = ControllerConstants.RESPONSE_404_BIO_PAGE_NOT_FOUND) })
  public ResponseEntity<List<BioLinkResponse>> getActiveBioLinksByPageId( @Parameter(description = ControllerConstants.PARAM_BIO_PAGE_ID) @PathVariable("pageId") Long pageId )
  {
