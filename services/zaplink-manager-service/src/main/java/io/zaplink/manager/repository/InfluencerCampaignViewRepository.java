...
//          */
//         List<InfluencerCampaignView> findByTeamMemberIdAndAssignmentStatus( Long teamMemberId,
...
//          */
//         List<InfluencerCampaignView> findByOrganizationIdAndAssignmentStatus( Long organizationId,
//                                                                               String assignmentStatus );
//         /**
...
//          */
//         @Query("SELECT icv FROM InfluencerCampaignView icv " + "WHERE icv.teamMemberId = :teamMemberId "
//                         + "AND icv.assignmentStatus = 'ASSIGNED' " + "AND icv.campaignStatus = 'ACTIVE'")
...
//          */
//         @Query("SELECT icv FROM InfluencerCampaignView icv " + "WHERE icv.teamMemberId = :teamMemberId "
//                         + "AND icv.assignmentStatus = 'COMPLETED' " + "ORDER BY icv.completedAt DESC")
...
//          */
//         @Query("SELECT icv FROM InfluencerCampaignView icv " + "WHERE icv.organizationId = :organizationId "
//                         + "AND icv.assignedAt BETWEEN :startDate AND :endDate " + "ORDER BY icv.assignedAt DESC")
