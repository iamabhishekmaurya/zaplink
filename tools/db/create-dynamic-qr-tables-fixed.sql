-- Dynamic QR Code Tables Migration Script (Fixed)
-- Execute this script to add dynamic QR functionality to your database
-- Includes track_analytics column fix
...
CREATE INDEX IF NOT EXISTS idx_track_analytics ON dynamic_qr_codes(track_analytics);
...
CREATE INDEX IF NOT EXISTS idx_qr_analytics_track_analytics ON qr_scan_analytics(track_analytics);
