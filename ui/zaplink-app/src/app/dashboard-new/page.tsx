                ...
                <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
                    ...
                    <div className="bg-muted/50 min-h-[100vh] flex-1 rounded-xl md:min-h-min flex items-center justify-center">
                        <div className="text-center">
                            ...
                            <p className="text-muted-foreground mb-4">Responsive sidebar-07 implementation</p>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-8">
                                <div className="bg-background rounded-lg p-4 border">
                                    <h3 className="font-semibold mb-2">Mobile Responsive</h3>
                                    <p className="text-sm text-muted-foreground">Sidebar collapses to icon on mobile</p>
                                </div>
                                <div className="bg-background rounded-lg p-4 border">
                                    <h3 className="font-semibold mb-2">Desktop Optimized</h3>
                                    <p className="text-sm text-muted-foreground">Full sidebar with navigation items</p>
                                </div>
                                <div className="bg-background rounded-lg p-4 border">
                                    <h3 className="font-semibold mb-2">Touch Friendly</h3>
                                    <p className="text-sm text-muted-foreground">Mobile sheet overlay on small screens</p>
                                </div>
                            </div>
                        </div>
                    </div>
