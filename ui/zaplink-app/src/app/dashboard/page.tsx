    ...
    return (
        <div className="container mx-auto px-4 py-10 flex flex-col gap-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Dashboard Overflow</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <Card>
                        <CardContent className="p-6 flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-sm font-medium text-muted-foreground">Unique Geo</p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <Card className="lg:col-span-2 shadow-sm">
                        <CardHeader>
                            ...
                            <CardDescription>Daily performance of all shortened links</CardDescription>
                        </CardHeader>
                ...
                <Card className="shadow-sm">
                    <CardHeader className="flex flex-row items-center justify-between">
                        <div>
                            ...
                            <CardDescription>Manage your most recently created short links</CardDescription>
                        </div>
                    ...
                    <CardContent>
                        <div className="overflow-x-auto">
                            <table className="w-full text-left">
                                <thead>
                                    <tr className="border-b text-sm font-medium text-muted-foreground uppercase tracking-wider">
