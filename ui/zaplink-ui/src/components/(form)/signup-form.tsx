...
export function SignupForm({
  ...
  const onSubmit = async (data: SignupSchema) => {
    try {
      ...
      // but our RegisterRequest type has it optional. The backend might ignore it or we can just send necessary fields.
      // Assuming backend handles it or ignores extra fields.
      ...
      if (registerUser.fulfilled.match(resultAction)) {
        ...
        showErrorToast(resultAction.payload as string || "Registration failed");
      }
    } catch (err) {
        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          ...
          <div className="bg-muted relative hidden md:block">
            <img
              ...
              alt="Image"
              className="absolute inset-0 h-full w-full object-cover dark:brightness-[0.5] dark:grayscale-[0.3]"
            />
          </div>
        </CardContent>
      </Card>
